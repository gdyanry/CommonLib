...
public abstract class LoginHandler {
     ...
     *
     * @param account the account to save which can be retrieved from
     *                {@link #getAccount()}
     */
     ...
     *
     * @param sessionId session id from server response.
     * @param uid       user id.
     */
     ...
     *
     * @param uid unique identifier of current user.
     */
