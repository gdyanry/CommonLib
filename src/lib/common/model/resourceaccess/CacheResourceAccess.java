 ...
 * 
 * @param <K>
 *            type of key used to access resource.
 * @param <R>
 *            type of target resource.
 * @param <O>
 *            type of resource access option.
 * @param <H>
 *            type of resource access hook.
 * @author yanry
 *
 *         2015年11月14日
 */
public abstract class CacheResourceAccess<K, R, O, H extends AccessHook<R>> {
	 ...
	 * 
	 * @param cacheCapacity
	 *            max number of task can be held in cache, excessive tasks will
	 ...
	 * @param key
	 * @param cached
	 *            cache value returned by {@link #getCacheValue(Object, Object)}
	 * @param option
	 * @param hook
